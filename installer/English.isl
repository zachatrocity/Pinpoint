...
; *** Common wizard text
ClickNext=Click Install Pinpoint to continue, or Cancel to exit Setup.
BeveledLabel=
...
; *** "Welcome" wizard page
WelcomeLabel1=You're about to install Pinpoint!
WelcomeLabel2=This will install [name/ver] on your computer.%n%nWe hope that you will find much enjoyment using Pinpoint.
